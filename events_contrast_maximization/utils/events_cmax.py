...
if __name__ == "__main__":
    ...
    # objectives = [zhu_timestamp_objective()]
    warp = linvel_warp()
    for obj in objectives:
        ...
        x_prime, y_prime, jacobian_x, jacobian_y = warp.warp(xs[start_idx:end_idx],
                                                             ys[start_idx:end_idx], ts[start_idx:end_idx], ps[start_idx:end_idx],ts[end_idx], argmax)
        # img = events_to_image(np.int64(x_prime), np.int64(y_prime), ps[start_idx:end_idx])
        # plot_image(img)
